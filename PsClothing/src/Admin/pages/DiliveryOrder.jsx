...
const DiliveryOrder = () => {
  ...
  let merchantId = JSON.parse(localStorage.getItem("bloomb/delivey/id"));
  let merchant_name = JSON.parse(localStorage.getItem("bloomb/delivey/login"));
  const data = {
    delivery_person_id: merchantId,
  };
  useEffect(() => {
    axios
      .post("https://www.bloomb.in/delivery/getAllDeliveryPersonOrder", data)
      .then((response) => {
